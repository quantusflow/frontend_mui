...
var DropDown = (function (_super) {
    ...
    DropDown.prototype.render = function () {
        ...
        return (React.createElement("div", __assign({}, qflProps),
            ...
            React.createElement(material_ui_1.DropDownMenu, __assign({}, muiProps, { value: this.state.currentValue, onChange: function (event, index, value) { return _this.handleChange(event, index, value); } }), items)));
    };
    return DropDown;
}(React.Component));

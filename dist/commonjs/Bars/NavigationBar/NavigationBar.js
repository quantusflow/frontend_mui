...
var index_js_1 = require("material-ui/Drawer/index.js");
var index_js_2 = require("material-ui/Divider/index.js");
var themeBuilder_1 = require("../../themeBuilder");
var index_js_3 = require("material-ui/List/index.js");
var SelectableList = index_js_3.makeSelectable(index_js_3.List); // tslint:disable-line variable-name
/**
...
var NavigationBar = (function (_super) {
    ...
    NavigationBar.prototype.render = function () {
                    ...
                    case 'List':
                        ...
                        return (React.createElement(SelectableList, __assign({ key: idx, className: item.className, value: location.pathname, onChange: function (e, route) { return _this.handleOnChange(e, route); } }, listMuiProps), nestedElements.map(function (nestedElement, nestedIdx) {
                            switch (nestedElement.type) {
                                case 'ListItem':
                                    return React.createElement(index_js_3.ListItem, __assign({ key: nestedIdx }, listItemMuiProps, { className: nestedElement.className, primaryText: nestedElement.label, value: nestedElement.path, leftIcon: nestedElement.icon }));
                                default:
                                    return null;
                            }
                        }).filter(function (itemToFilter) { return (itemToFilter !== null); })));
                    case 'Divider':
                        return React.createElement(index_js_2.default, __assign({ key: idx }, dividerMuiProps));
                    case 'fillBar':
        ...
        return (React.createElement("div", __assign({}, qflProps),
            React.createElement(index_js_1.default, __assign({}, muiProps, { open: true, docked: true }), renderedMenu)));
    };
